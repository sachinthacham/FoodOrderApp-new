...
{
    //here use interface segregation principle
    //instead of using IMediator we can use ISender
    //ISender is a more specific interface that only exposes the Send method
